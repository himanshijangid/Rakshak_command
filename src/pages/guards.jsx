...
const GuardCard = ({ title, image }) => {
  return (
    <div
      className="w-full md:w-1/3 p-4"
      data-aos="fade-up"
    >
      <div className="bg-white/90 rounded-lg shadow-lg overflow-hidden relative hover:shadow-xl transition-shadow duration-300">
        <div className="relative w-full h-[270px] md:h-[320px] overflow-hidden">
          <img
            src={image}
            alt={title}
